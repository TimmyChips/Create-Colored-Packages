...
public class HandPointerInteractionHandlerMixin {
    ...
    private static boolean coloredPackages$modifyPackagerBool(boolean original, Player player, Level level, BlockPos pos, BlockState state) {
    ...
    private static boolean coloredPackages$modifyRepackagerBool(boolean original, Player player, Level level, BlockPos pos, BlockState state) {
        if (original) return true;
